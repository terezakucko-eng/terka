...
Písmo: DM Sans (Regular pro běžný text, SemiBold pro nadpisy a názvy lekcí). Rukopisné písmo Allura je v projektu připravené jen pro krátké ozdobné nápisy, delší texty (claim) jsou v DM Sans. Nápis OCTOPUSH v logu zůstává vlastní vektorový (SVG v `public/brand`).
